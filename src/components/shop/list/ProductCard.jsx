		...
		<Card className="gap-6">
			...
			<div className="flex flex-col gap-4 px-4 pb-4">
				<div className="flex justify-between items-center">
					...
					<ButtonOutline className="font-secondary" color="text-secondary">{ categoryName[category] }</ButtonOutline>
					<p className="flex font-secondary gap-2 items-center text-primary">
						{ rating }
						<FaStar />
					</p>
				</div>
				...
				<div className="flex justify-between items-center">
					<p className="font-secondary font-bold tracking-widest text-primary">{ price } €</p>
					<ButtonFilled>
						<FaCartPlus />
					</ButtonFilled>
				</div>
