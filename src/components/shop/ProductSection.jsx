...
export default function ProductSection({ addToCart, products, defaultValues, minPrice, setMinPrice, maxPrice, setMaxPrice, inStock, setInStock }) {
	return (
		<Section className="flex flex-col md:flex-row justify-between gap-4">
			...
			<ProductList addToCart={ addToCart } filteredList={ products } />
		</Section>
	)
}