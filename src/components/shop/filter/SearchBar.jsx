...
export default function SearchBar({ searchValue, setSearch }) {
	...
	return (
		<div className="flex gap-0 w-full">
			...
			<Input className="w-full" border="border-y border-secondary"
				placeholder="Suchen..."
				onChange={ (event) => setSearch(event.target.value) }
				value={ searchValue } 
			/>
			<div className="flex justify-center items-center border-r border-y border-secondary px-2 py-2 rounded-r-md">
