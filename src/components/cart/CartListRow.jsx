	...
	return (
		<li className="flex gap-3 justify-between p-4 max-h-30 bg-background-mid border border-background-card rounded-md">
			<div className="flex gap-3 max-w-full">
				...
				<div className="max-w-35 md:max-w-100 flex flex-col gap-2 justify-center">
			...
			<div className="flex flex-col gap-3 justify-center text-right">
				<p className="text-xs">{ product.price.toLocaleString("de-De") }€</p>
				<p className="text-primary font-bold text-lg">{ totalPrice.toLocaleString("de-De") }€</p>
			</div>
		</li>
	)
}